package com.ftc300.androidskills.go;
...
import com.inso.go_lib.OverloadPolicy;
import com.inso.go_lib.SchedulePolicy;
import com.inso.go_lib.SmartExecutor;
...
public class GoMainAct extends AppCompatActivity {
    protected String TAG = GoMainAct.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_go_main);
        activity = this;
        initViews();
        initSmartExecutor();
    ...
    private void initViews() {
        ...
        mAdapter = new ArrayAdapter<String>(this, R.layout.go_item, R.id.tv_item,
        ...
        switch (which) {
            case 0:
                ...
                mainExecutor.submit(new Runnable() {
                    @Override
                    public void run() {
                        Log.i(TAG, " Runnable start!  thread id: " + Thread.currentThread().getId() + ",name:" + Thread.currentThread().getName());
                        try {
                            Thread.sleep(2000);
                        } catch (InterruptedException e) {
                            e.printStackTrace();
                        }
                        Log.i(TAG, " Runnable end!  thread id: " + Thread.currentThread().getId()+ ",name:" + Thread.currentThread().getName());
                    }
                });
                break;
            ...
            case 1:
                ...
                FutureTask<?> futureTask = new FutureTask<String>(new Callable<String>() {
                    ...
                    public String call() throws Exception {
                        Log.i(TAG, " FutureTask thread id: "  + Thread.currentThread().getId()+ ",name:" + Thread.currentThread().getName());
                ...
                try {
                    Log.i(TAG,(String)futureTask.get());
                } catch (InterruptedException e) {
                    e.printStackTrace();
            ...
            case 2:
                ...
                Callable<?> callable = new Callable<String>() {
                    @Override
                    public String call() throws Exception {
                        Log.i(TAG, " Callable thread id: "  + Thread.currentThread().getId()+ ",name:" + Thread.currentThread().getName());
                        return "Callable";
                    }
                };
                mainExecutor.submit(callable);
