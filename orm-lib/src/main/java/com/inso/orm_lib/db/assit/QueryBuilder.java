...
public class QueryBuilder<T> {
     ...
     *                  new Integer[]{1,2}
     */
    public QueryBuilder<T> where(String where, String[] whereArgs) {
     ...
     *                  new Integer[]{1,2}
     */
    public QueryBuilder<T> whereAppend(String where, String[] whereArgs) {
     ...
     *                  new Integer[]{1,2}
     */
    public QueryBuilder<T> whereAnd(String where, String[] whereArgs) {
     ...
     *                  new Integer[]{1,2}
     */
    public QueryBuilder<T> whereOr(String where, String[] whereArgs) {
     ...
     */
    public QueryBuilder<T> whereIn(String column, String[] values) {
